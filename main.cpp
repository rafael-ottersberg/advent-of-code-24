...
#include "day07cu/day07.hpp"
#include "day07cu_m/day07.hpp"
...
int main() {
    ...
    std::cout << time_function(d07pt1cu_m, folder_path / "input.txt") << std::endl;
    ...
    std::cout << time_function(d07pt2cu_m, folder_path / "input.txt") << std::endl;
    return 0;
}